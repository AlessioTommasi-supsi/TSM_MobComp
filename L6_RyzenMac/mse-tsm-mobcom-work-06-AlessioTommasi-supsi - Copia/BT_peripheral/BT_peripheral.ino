// Heart Rate Monitor BLE peripheral.
...
#include "Adafruit_TinyUSB.h" // Fix https://github.com/adafruit/Adafruit_nRF52_Arduinxx  xo/issues/653
#include <bluefruit.h>

/*Servizi che vogliamo creare */
...
void cccdCallback(uint16_t connectionHandle, BLECharacteristic* characteristic, uint16_t cccdValue) { //cosa succede se qualcuno abilita notifiche del servizio
...
void startAdvertising() {
  ...
  // See https://developer.apple.com/library/content/qa/qa1931/_index.html   //good interval find by apple
